package com.povush.modusvivendi.ui.thoughtrealm
...
object ThoughtrealmDestination : NavigationDestination {
    ...
    override val titleRes = R.string.thoughtrealm
}

@Composable
fun ThoughtrealmScreen(onNavigationClick: () -> Unit) {
    Scaffold(
        modifier = Modifier,
        topBar = {
            ModusVivendiAppBar(
                titleRes = ThoughtrealmDestination.titleRes,
                navigation = {
