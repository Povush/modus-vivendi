    ...
    NavHost(
        ...
        composable(
            ...
            QuestEditScreen(
                ...
                questId = navController.previousBackStackEntry?.savedStateHandle?.get("questId"),
                currentQuestSectionNumber = navController.previousBackStackEntry?.savedStateHandle?.get("currentQuestSectionNumber"),
            )
        }
